              ...
              .map((row) => (
                ...
                <TableRow hover role="checkbox" tabIndex={-1} key={row.Id}>
                  <TableCell>
                    ...
                    {row.PurchasedItems.map((data) => (<span>{data.Description}<br /></span>))}
                  ...
                  <TableCell >
                    ...
                    {row.PurchasedItems.map((payment) => (<span>{(parseInt(payment.TotalAmount) - parseInt(payment.TaxAmount)).toFixed(2)}<br /></span>))}
